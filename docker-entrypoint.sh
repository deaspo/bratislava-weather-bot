...
echo "🌍 Starting Multi-City Weather Bot v2.0# Use Python scheduler instead of cron (more reliable in Docker)
...
echo "   📅 Main updates: Every hour at minute 0 (12:00, 1:00, 2:00, etc.)"
...
exec python3 python_scheduler.pyn Caprover, environment variables are set directly in the dashboard
